...
vec3 Lighting(int i){
    ...
    vec3 diffuseColor=lights[i].color*texture(material.texture_diffuse1,fs_in.texCoord).rgb;
    ...
    vec3 specularColor=texture(material.texture_diffuse1,fs_in.texCoord).rgb*lights[i].color;
